  ...
  const handleReset = async (e) => {
    ...
    try {
      const { data } = await axios.put(
        `http://localhost:3004/api/v1/user/reset/password/${token}`,
            ...
            <form onSubmit={handleReset} className="space-y-6">
              <div className="relative group">
                <input
                  ...
                  className="w-full pl-4 py-3.5 border border-gray-200 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 outline-none text-gray-800"
                />
              </div>
